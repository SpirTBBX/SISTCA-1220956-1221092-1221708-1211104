...
docker exec router1 chmod +x /etc/startup-exA.sh
docker exec router2 chmod +x /etc/startup-exA.sh
docker exec router3 chmod +x /etc/startup-exA.sh
...
docker exec router1 /etc/startup-exA.sh
docker exec router2 /etc/startup-exA.sh
docker exec router3 /etc/startup-exA.sh
